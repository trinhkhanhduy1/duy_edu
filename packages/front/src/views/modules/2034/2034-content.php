...
<div class="type-2034">
    ...
    <!--MENU-->
    <div id="navbar">
        <nav class="navbar navbar-default " role="navigation" id="menu-home" >
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown show-hover">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="event">Event Detail</a></li>
                            </ul>
                        </li>
                        <!--/END MENU DROP DOWN-->
                        ...
                        <!--MENU DROP DOWN-->
                        <li class="dropdown show-hover">
                            <a href="courses" class="dropdown-toggle" data-toggle="dropdown">Courses</a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="courses">Courses</a></li>
                                <li><a href="courses">Course Detail</a></li>
                            </ul>
                        </li>
                        <!--/END MENU DROP DOWN-->
                        ...
                        <!--MENU DROP DOWN-->
                        <li class="dropdown show-hover">
                            <a href="page" class="dropdown-toggle" data-toggle="dropdown">Pages</a>
                            <ul class="dropdown-menu" role="menu">
